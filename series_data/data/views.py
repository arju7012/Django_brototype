...
def series_list_view(request):
    ...
    """
    context = {
        'all_series': series.values() # Pass only the values (the inner dictionaries)
        # If you needed the keys like "series_01", you would use .items():
        # 'all_series_items': series_data.items()
    }
